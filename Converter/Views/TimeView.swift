...
struct TimeView: View {
    @StateObject private var viewModel = TimeViewModel() // Get data from TimeViewModel()
    var body: some View {
        ZStack {
            BackgroundView()
            VStack {
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        DropView(selectedItem: $viewModel.fromUnit, items: ["Hour", "Minute", "Second"])
                    }
                }
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        DropView(selectedItem: $viewModel.toUnit, items: ["Hour", "Minute", "Second"])
                    }
                }
