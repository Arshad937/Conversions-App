...
// Pressure View Design

import SwiftUI
import Combine

struct PressureView: View {
    @StateObject private var viewModel = PressureViewModel() // get data from PressureViewModel()
    var body: some View {
        ZStack {
            BackgroundView()
            VStack {
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        DropView(selectedItem: $viewModel.fromUnit, items: ["Bar", "Torr", "Pascal"])
                    }
                }
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        DropView(selectedItem: $viewModel.toUnit, items: ["Bar", "Torr", "Pascal"])
                    }
                }
